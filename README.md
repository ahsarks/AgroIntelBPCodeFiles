...
![Example Activity Snapshot:](images/Activitysnapshot(2).png)
...
Train_reID.py
Trains the reID model on a limited 10 cattle using images of different cattle and saves the best weights for inference.  
